<div class="btn-group">
    ...
    <a class="btn btn-default btn-sm" data="{{$data->slug}}" target="_self" href="{{route('dashboard.ris.edit',$data->slug)}}" >
        <i class="fa fa-edit"></i>
    </a>
    <button type="button" onclick="delete_data('{{$data->slug}}','{{route("dashboard.ris.destroy",$data->slug)}}')" class="btn btn-sm btn-danger" data-toggle="tooltip" title="" data-placement="top" data-original-title="Delete">
